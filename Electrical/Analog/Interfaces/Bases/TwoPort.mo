...
partial model TwoPort "Component with two electrical ports, including current"
  ...
  replaceable Modelica.Electrical.Analog.Interfaces.PositivePin p1 constrainedby
  ...
  replaceable Modelica.Electrical.Analog.Interfaces.NegativePin n1 constrainedby
  ...
  replaceable Modelica.Electrical.Analog.Interfaces.PositivePin p2 constrainedby
    Modelica.Electrical.Analog.Interfaces.PositivePin
    "Positive pin of the right port (potential p2.v > n2.v for positive voltage drop v2)"
                                                                                                       annotation (Placement(
        transformation(extent={{110,40},{90,60}}, rotation=0)));
  replaceable Modelica.Electrical.Analog.Interfaces.NegativePin n2 constrainedby
    Modelica.Electrical.Analog.Interfaces.NegativePin
