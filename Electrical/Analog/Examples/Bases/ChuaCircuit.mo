...
encapsulated model ChuaCircuit "Chua's circuit, ns, V, A"
 ...
 // replaceable class Utilities = ADMSL.Electrical.Analog.Basic;
  ...
  Basic.Bases.Inductor L(L=18) annotation (Placement(transformation(
        origin={-75,38},
        extent={{-25,-25},{25,25}},
        rotation=270)));
  Basic.Bases.Resistor Ro(R=12.5e-3) annotation (Placement(transformation(
        origin={-75,-17},
        extent={{-25,-25},{25,25}},
        rotation=270)));
  Basic.Bases.Conductor G(G=0.565) annotation (Placement(transformation(extent={{-25,38},
            {25,88}},      rotation=0)));
  Basic.Bases.Capacitor C1(C=10, v(start=4)) annotation (Placement(transformation(
        origin={25,3},
        extent={{-25,-25},{25,25}},
        rotation=270)));
  Basic.Bases.Capacitor C2(C=100) annotation (Placement(transformation(
        origin={-25,3},
        extent={{-25,-25},{25,25}},
        rotation=270)));
  Utilities.Bases.NonlinearResistor Nr(
    ...
    Ve=1) annotation (Placement(transformation(
        ...
        extent={{-25,-25},{25,25}},
        rotation=270)));
  Basic.Bases.Ground Gnd annotation (Placement(transformation(extent={{-25,-112},{25,
            -62}}, rotation=0)));
equation
